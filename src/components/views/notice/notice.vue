<template>
    <div class="child">
        ...
        <!-- example 2 -->
        <Divider orientation="left">提醒类型</Divider>
        <p>带描述信息</p>
        ...
        <!-- example 3 -->
        <Divider orientation="left">手动关闭</Divider>
...
<script>
import {notice} from '@/js/tool/part.js';
let {htmlCode,jsCode} = {htmlCode:notice.html,jsCode:notice.js};
