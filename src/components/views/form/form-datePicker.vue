...
<script>
import {datePicker} from '@/js/tool/part.js';
const {htmlCode,jsCode} = {htmlCode:datePicker.html,jsCode:datePicker.js};

export default {
  name: 'form-datePicker',
  data () {
    return {
      value: 'this is form-datePicker.vue 。',
      htmlCode,
      jsCode,
      switch1:[],
      value1: '2018-10-01',
      value2: ['2017-9-01', '2018-10-8']
    }
  },
  props: {
    name: {
