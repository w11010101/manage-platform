        ...
        <Layout>
            <Card class='logoCard' shadow>
                ...
                <div class='btnBox'>
                    ...
                    <Button type="success" class="login" to="/layoutView">登录</Button>
                    <Button type="primary" class="register" to="/layoutView">注册</Button>
...
//     popup_redirect_uri: 'http://localhost:8081/layoutView',
